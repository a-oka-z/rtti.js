...
const VANILLA_SCHEMA_VALIDATOR_MODULE_DATA       = Symbol.for( VANILLA_SCHEMA_VALIDATOR_MODULE_DATA_ID    );
const VANILLA_SCHEMA_VALIDATOR_MODULE_TYPE       = Symbol.for( VANILLA_SCHEMA_VALIDATOR_MODULE_TYPE_ID    );
...
function get_schema_module_data( schema ) {
