...
asyncProc( 'template/transpile.template.cjs',  'transpile.js',  'lib/transpile.cjs'  ).then(v=>console.log(v)).catch(v=>console.error(v));
asyncProc( 'template/transpile.template.mjs',  'transpile.js',  'lib/transpile.mjs'  ).then(v=>console.log(v)).catch(v=>console.error(v));
